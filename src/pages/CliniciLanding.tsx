  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        />
        {/* Gradient overlay */}
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-white/70 via-white/50 to-white/90" />
        {/* Grid pattern */}
        <div
        ...
        />
        {/* Radial glow */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-blue-500/5 blur-3xl pointer-events-none z-[3]" />
